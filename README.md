...
<h1 align="center">LaptopTester v3.3.1</h1>
...
<p align="center">
  ...
  <a href="https://github.com/anlvdt/LaptopTester/releases/latest"><img src="https://img.shields.io/badge/Download-v3.3.1-blue?style=for-the-badge" alt="Download"></a>
</p>
...
**[Tải LaptopTester v3.3.1](https://github.com/anlvdt/LaptopTester/releases/latest)** -- File .exe (~271 MB), tích hợp runtime, không cần cài đặt, chạy từ USB.
...
| Version | Ghi chú |
|---------|---------|
| v3.3.1 | Patch: fix Settings layout, Shopee Affiliate, license path portable. |
...
**[Download LaptopTester v3.3.1](https://github.com/anlvdt/LaptopTester/releases/latest)** -- Single .exe (~271 MB), runtime included, no installation, runs from USB.
